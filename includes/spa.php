...
<div class="col-md-5">
  <h6>BOTOX <span class="price">$12/<small>unit</small></span></h6>
  <p>a drug prepared from the bacterial toxin botulin, used cosmetically to decrease wrinkles by temporarily weakening facial muscles</p>
  <hr>
  <h6>JUVEDERM ULTRA <br />OR ULTRA PLUS XC <span class="price"><small>1CC</small> $679 |  <small>2CC</small> $1099</span></h6>
  <p>An injectable facial filler used to temporarily soften deep folds and wrinkles of the face; made of hyaluronic acid, a substance normally found in skin.</p>
  <hr>
  <h6>PERMANENT HAIR REDUCTION<span class="price">$50<small> & up</small></span></h6>
  <h6>LASER VEIN THERAPY <span class="price">$150<small> & up</small></span></h6>
  <p>Treatment of spider veins</p>
  <hr>
</div>
<div class="col-md-5">
  <h6>LASER GENESIS TREATMENT<span class="price">$175<small> & up</small></span></h6>
  <p>Treatment of wrinkles, large pores, skin texture & redness</p>
  <hr>
  ...
  <hr>
  <h6>MICROCHANNELING TREATMENT <span class="price">$249</span></h6>
  <p>Improves the appearance of fine lines, wrinkles, stretch marks, scars, acne</p>
  <hr>
</div>
</div>

<h1>Day Spa Services<br />
<img class="divider" src="images/g-divider.png">
</h1>
...
<div class="col-md-5">
  ...
  <p>All Skin Types, Brightens Complexion</p>
  <hr>
  <h6>IMAGE PERFECTION LIFT<span class="price">$149</span></h6>
  <p>Advanced Aging, Acne, & Sun Spots</p>
  <hr>
</div>
</div>
</div> <!-- CONTAINER END -->
